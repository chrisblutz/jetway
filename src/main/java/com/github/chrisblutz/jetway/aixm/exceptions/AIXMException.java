 ...
 * to the loading of AIXM data or the conversion of AIXM data into Java types.
 *
 * @author Christopher Lutz
 */
public class AIXMException extends RuntimeException {
     ...
     */
    public AIXMException(String message) {
     ...
     */
    public AIXMException(String message, Exception cause) {
